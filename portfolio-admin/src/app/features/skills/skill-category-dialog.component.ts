...
import { SkillCategory } from '../../core/services/skills.service';
...
@Component({
  selector: 'app-skill-category-dialog',
  standalone: true,
  imports: [
    ReactiveFormsModule,
    MatDialogModule,
...
export class SkillCategoryDialogComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<SkillCategoryDialogComponent>,
  ...
  ngOnInit(): void {
    if (this.data.category) {
      ...
      if (this.data.category.iconUrl) {
        this.iconPreview.set(this.data.category.iconUrl);
      }
    }
  }
  ...
  submit(): void {
    ...
    this.dialogRef.close({ formData: fd } as CategoryDialogResult);
  }
}
